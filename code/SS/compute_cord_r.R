...
r_lat = compute_b(path_to_test = test_prefix, testvec_file = tvec_file_north, test_type = "north", outpath = out_prefix)
...
# Compute b for latitude
r_long = compute_b(path_to_test = test_prefix, testvec_file = tvec_file_east, test_type = "east", outpath = out_prefix)
